...
export type LineItem = "Revenue" | "COGS" | "EBITDA" | "Total Assets" | "Total Liabilities" | "Long-term Debt";
...
export const financialData: FinData = {
  ...
  "Samsung Biologics": {
    ...
    "EBITDA": { 2022: 0.24, 2023: 0.26, 2024: 0.28, 2025: 0.3 },
...
export const lineItems: LineItem[] = ["Revenue", "COGS", "EBITDA", "Total Assets", "Total Liabilities", "Long-term Debt"];
